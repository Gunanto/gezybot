...
- **UI/PWA : rétrogradée de #1 à statut de preuve transversale.** Elle infuse tous les piliers (c'est *grâce à* l'UI polie que Queenie, les mini-apps, les avatars brillent) mais n'est pas un pilier autonome défendable.
