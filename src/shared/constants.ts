...
/** Below this many items a settings list hides its search/filter bar — a filter
 *  bar over three rows is just noise. Used by list screens (channels, webhooks,
 *  contacts, …) to decide when the ListToolbar appears. */
